...
public class Probability {
	...
	public final static double male_male = 0.04; // 6 percent - anal intercourse
	public final static double male_female = 0.01; // 1 percent - female infected
	public final static double female_male = 0.02; // 3 percent - male infected
	public final static double female_female = 0.01; // 1 percent
